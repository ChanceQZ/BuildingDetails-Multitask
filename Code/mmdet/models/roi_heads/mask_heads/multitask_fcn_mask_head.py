...
class MultitaskFCNMaskHead(BaseModule):
    ...
    def __init__(self,
        ...
        super(MultitaskFCNMaskHead, self).__init__(init_cfg)
        ...
        out_channels = 1 if self.class_agnostic else self.num_classes * self.num_classes_aux
        logits_in_channel = (
            self.conv_out_channels
    ...
    def init_weights(self):
        super(MultitaskFCNMaskHead, self).init_weights()
    ...
    def loss(self, mask_pred, mask_targets, labels):
        ...
        """
        loss = dict()
        labels = labels[:, 0] * self.num_classes_aux + labels[:, 1]
    ...
    def get_seg_masks(self, mask_pred, det_bboxes, det_labels, rcnn_test_cfg,
        ...
        cls_segms = [[] for _ in range(self.num_classes * self.num_classes_aux)
